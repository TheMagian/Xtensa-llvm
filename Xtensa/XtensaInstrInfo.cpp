...
unsigned XtensaInstrInfo::RemoveBranch(MachineBasicBlock &MBB) const 
{
  // Most of the code and comments here are boilerplate.
  MachineBasicBlock::iterator I = MBB.end();
  unsigned Count = 0;
...
unsigned
XtensaInstrInfo::InsertBranchAtInst(MachineBasicBlock &MBB, MachineInstr *I,
...
bool XtensaInstrInfo::isBranch(const MachineInstr *MI, SmallVectorImpl<MachineOperand> &Cond,
